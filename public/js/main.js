...
function code()
  {
       ...
       var demo ='<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta http-equiv="X-UA-Compatible" content="IE=edge"><meta name="viewport" content="width=device-width, initial-scale=1.0"><style>'+ editor.getCss()+'</style><title>Document</title></head> '+editor.getHtml()+'</html>';
      //alert(editor.getCss());
      //  var demojs = editor.getJs();
    //    alert(demo);
